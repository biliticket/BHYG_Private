...
i18n = {
    i18n_tuple[0]: {
        ...
        "choose_mode": "请选择抢票模式",
        "start_up": "项目主页: https://github.com/biliticket/BHYG GPL-3.0 删除本信息或盗版必究。版本号：{}",
        ...
        "input_status_delay": "请输入票务信息检测时间间隔(该选项影响412风控概率，单位秒): ",
        ...
        "info_no_ticket": "未开放购票或被风控，请检查配置问题，休息2s",
        "info_bill_ok": "成功准备订单",
        ...
        "try_load_local_captcha": "尝试加载本地验证码模块",
        "load_success": "加载成功",
        "local_captcha_load_failed": "本地验证码模块加载失败，错误信息：{}，请使用其他验证方式",
        "tips": "提示: \n1. 提前在实用工具预填账号绑定手机号，可以不用开票时手忙脚乱填写！\n2. 抢一张票，多开是没有用的！\n3. 提前测试GT模块是否可用，方式：验证码登录/用户名密码登录，GT模块不能用建议换台电脑/系统！\n",
        "key_not_match": "密钥使用条件错误，请检查登录机器和UID",
    ...
    i18n_tuple[1]: {
        ...
        "start_up": "Homepage: https://github.com/biliticket/BHYG GPL-3.0 Delete this information or pirate will be prosecuted. Version: {}",
        ...
        "info_no_ticket": "Not buyable or be risk controlled, Please check config. Delay 2s.",
        ...
        "tips": "Tips: \n1. In advance in the utility pre-fill account binding mobile phone number. You can not fill in the ticket when scrambling!\n"
        "2. Open more windows is useless if you feel like grabbing A ticket!\n"
        "3. Test the GeeTest module is available in advance. Method: Verification code login/username password login. GeeTest module can not use the proposal to change the computer or OS!\n",
        "key_not_match": "Incorrect secret key usage condition! please check login machine and UID.",
        "key_expired": "The secret key has expired. Please get it again.",
    ...
    i18n_tuple[2]: {
        ...
        "start_up": "项目主页: https://github.com/biliticket/BHYG GPL-3.0 删除本信息或盗版必究喵~。版本: {} Ciallo～(∠・ω< )⌒☆",
        ...
        "common_project_id": "本猫推荐你去的几个展子如下喵~：",
        "empty": "打咩, 暂时没有喵~",
        ...
        "info_no_ticket": "未开放购票或被风控，请检查配置问题，休息2s咪~",
        ...
        "tips": "本猫给你们一点点小小的提示喵~: \n1. 提前在我的实用工具里面喂给我账号绑定的手机号，开票时就不用手忙脚乱的填写啦喵！\n2. 主人如果只想抢一张票，多开是没什么大用的喵！\n3. 提前测试我的GT模块是否可用喵，方法：验证码登录/用户名密码登录，GT模块不能用咬咬牙加钱换台电脑或者换系统喵！\n",
